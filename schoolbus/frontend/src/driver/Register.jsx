          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="md:flex">
                <div className="md:w-1/2 bg-gradient-to-br from-yellow-500 to-amber-600 p-10 text-white flex flex-col justify-center">
                  <h2 className="text-3xl font-bold mb-6">Join Our Driver Team</h2>
                  <p className="mb-6">Create an account to manage your routes, communicate with parents, and access important information.</p>
                  <ul className="space-y-4">
                    {[
                      ...
                      >
                        <svg className="w-5 h-5 mr-2 text-yellow-200" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="mt-8">
                    ...
                    <Link to="/driver/login" className="text-yellow-200 hover:text-white font-medium mt-2 inline-block">
                ...
                <div className="md:w-1/2 p-8">
                  <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold text-gray-800">Driver Registration</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      <label htmlFor="licenseNumber" className="block text-gray-700 text-sm font-medium mb-1">Driver License Number</label>
                      <input
                        type="text"
                        id="licenseNumber"
                        name="licenseNumber"
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.licenseNumber ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-indigo-100'}`}
