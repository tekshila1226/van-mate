                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border ${errors.firstName ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      className={`w-full px-3 py-2 border ${errors.lastName ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      className={`w-full px-3 py-2 border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      className={`w-full px-3 py-2 border ${errors.phone ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
                    {errors.phone && <p className="mt-1 text-sm text-red-500">{errors.phone}</p>}
                  </div>
                </div>
                
                <h2 className="text-lg font-medium text-gray-800 mb-4">Driver Information</h2>
                <div className="grid grid-cols-1 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      className={`w-full px-3 py-2 border ${errors.licenseNumber ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border ${errors.currentPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handlePasswordChange}
                      className={`w-full px-3 py-2 border ${errors.newPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handlePasswordChange}
                      className={`w-full px-3 py-2 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-200`}
                    />
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-lg font-medium text-gray-800">Driver</p>
            </div>
