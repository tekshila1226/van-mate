...
import { HiShieldCheck, HiUserGroup, HiAcademicCap, HiCog } from 'react-icons/hi2';
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="md:flex">
                <div className="md:w-1/2 bg-gradient-to-br from-blue-700 to-indigo-800 p-10 text-white flex flex-col justify-center">
                  <h2 className="text-3xl font-bold mb-6">School Administration</h2>
                  <p className="mb-6">Create an admin account to manage your school's bus transportation system efficiently.</p>
                  <ul className="space-y-4">
                    {[
                      "Manage all drivers and routes",
                      "Monitor student transportation",
                  ...
                  <div className="mt-8">
                    ...
                    <Link to="/admin/login" className="text-blue-200 hover:text-white font-medium mt-2 inline-block">
                ...
                <div className="md:w-1/2 p-8">
                  <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold text-gray-800">Administrator Registration</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.firstName ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                          placeholder="John"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.lastName ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                          placeholder="Doe"
                        />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.email ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.phone ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                    ...
                    {/* <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.schoolName ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                        placeholder="••••••••"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.confirmPassword ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                        placeholder="••••••••"
                      />
