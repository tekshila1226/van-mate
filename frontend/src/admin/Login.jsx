            ...
            >
              <div className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-gray-800">Administrator Login</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.email ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'}`}
                      placeholder="••••••••"
                    />
                ...
                <div className="mt-8 text-center">
                  <p className="text-sm text-gray-500 mb-4">Sign in as</p>
                  <div className="flex justify-center space-x-4">
                    <Link to="/parent/login" className="text-gray-600 hover:text-blue-600 transition-colors">
                      Parent
                    </Link>
                    <span className="text-gray-300">|</span>
                    <Link to="/driver/login" className="text-gray-600 hover:text-blue-600 transition-colors">
                      Driver
                    </Link>
                  </div>
                </div>
