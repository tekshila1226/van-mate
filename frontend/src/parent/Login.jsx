            ...
            >
              <div className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-gray-800">Parent Login</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.email ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-indigo-100'}`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 ${formErrors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-indigo-100'}`}
                      placeholder="••••••••"
                    />
                ...
                <div className="mt-8 pt-6 border-t border-gray-200 text-center">
                  <p className="text-gray-600">
                    ...
                    <Link to="/parent/register" className="text-indigo-600 hover:text-indigo-800 font-medium">
                      Create an account
                    </Link>
                  </p>
                </div>
                ...
                <div className="mt-8 text-center">
                  ...
                  <div className="flex justify-center">
                    <Link to="/driver/login" className="text-gray-600 hover:text-indigo-600 transition-colors">
                      Driver
                    </Link>
                  </div>
                </div>
